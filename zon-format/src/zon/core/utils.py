"""Utility functions for ZON string quoting and value parsing."""
...
def quote_string(s: str) -> str:
    """Quote a string value according to ZON format rules.
    ...
    Returns:
        The appropriately quoted string for ZON format
    """
    if re.match(r'^-?\d+(\.\d+)?$', s):
        return f'"{s}"'
